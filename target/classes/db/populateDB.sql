...
VALUES /*первое мая*/
       ...
       /*данные предпоследнего дня*/
       ('2021-05-04 0:00:00', 1018),
       ('2021-05-04 0:00:00', 1016),
       ('2021-05-04 0:00:00', 1017),
       /*новые данные*/
       ('2021-05-14 0:00:00', 1015),
       ('2021-05-14 0:00:00', 1017),
       ('2021-05-14 0:00:00', 1018),
       ('2021-05-14 0:00:00', 1016);
...
INSERT INTO VOTES (USER_ID, MEAL_ID)
VALUES (1000, 1027),
       (1001, 1027),
       (1002, 1028),
       (1003, 1028),
