...
public class MealTestData {
    ...
    public static final int MEAL_ID = 1019;

    public static final Meal meal1 = new Meal(/*MEAL_ID, LocalDateTime.of(2021, Month.MAY, 3, 0,0), */);

}
/*
public class MealTestData {
    public static final TestData.TestMatcher<Meal> MEAL_MATCHER = TestData.TestMatcher.usingIgnoringFieldsComparator("user");
